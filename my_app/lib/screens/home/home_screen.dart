                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: const Text('Tổng quan', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)),
                      ),
                    ),
                    const Expanded(
                      child: Center(
                        child: Text('Nhiệm vụ của tôi', style: TextStyle(color: Colors.grey, fontSize: 12)),
                      ),
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      "TASK ĐANG THỰC HIỆN",
                      style: TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: accentColor, letterSpacing: 0.5),
                    ),
