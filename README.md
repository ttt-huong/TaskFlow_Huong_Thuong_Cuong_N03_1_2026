...
Khoi tao cau truc du an Flutter.
Cap nhat tieu de ung dung thanh ten ung dung nhom.
Hien thi danh sach thanh vien nhom tren man hinh chinh.
Giu nguyen giao dien va mau sac theo mau ban dau.
Thanh vien nhom
Tran Thi Thu Huong - 23010344
Nguyen Thi Thuong - 23010308
Nguyen Viet Cuong - 23010551
Cach chay du an
Cai dat Flutter SDK.
...
Trần Thị Thu Hường (Trưởng nhóm)
...
Link GitHub Repository: https://github.com/ttt-huong/TaskFlow_Huong_Thuong_Cuong_N03_1_2026
Link README.md: https://github.com/ttt-huong/TaskFlow_Huong_Thuong_Cuong_N03_1_2026/blob/main/README.md
🛠 Kiến trúc ứng dụng
...
Link Repository
TaskFlow_Huong_Thuong_Cuong_N03_1_2026
Thành viên nhóm
...
MainScreen phân tách nav theo role.
HomeScreen load dữ liệu theo Manager/Member.
TaskProvider kiểm tra hợp lệ trước khi đổi trạng thái.
Task model định nghĩa state-machine cho workflow.
project_task_screen.dart xử lý Calendar Tab theo deadline.
task_detail_screen.dart hiển thị trạng thái quá hạn.
